...
import { ChipOld } from "../../general-components/ChipOld";
import { IconSearch } from "../../general-components/IconSvg/IconSearch"
import classes from "./style.module.css";
import linha2 from "../../../assets/icons/icon-contract/contract-sidebar-home.svg"
interface Props {
  filter: "off" | "on";
  filterArea: "select-and-date-pickers" | "closed" | "chips" | "opened";
  size: "large" | "small";
  className?: React.CSSProperties;
  textInputClassName?: React.CSSProperties;
  linha: string;
  chipOldTypeTableStatusClassName?: string | Record<string, unknown>;
}

export const TableFilterBarSubsection = ({
  filter,
  filterArea,
  size,
  className,
...
TableFilterBarSubsection.propTypes = {
